...
sap.ui.define(['jquery.sap.global', 'sap/m/InputBase', 'com/bnsf/tne/bnsfContols/MaskInput', 'com/bnsf/tne/bnsfContols/MaskInputRule', 'sap/m/ResponsivePopover', 'sap/ui/core/EnabledPropagator', 'sap/ui/core/IconPool', 'sap/ui/model/type/Time', './TimePickerSliders'],
...
//		jQuery.sap.require("com.bnsf.tne.bnsfContols.MaskInputRule");
//		jQuery.sap.require("com.bnsf.tne.bnsfContols.MaskInput");
		 ...
		 */
		var TimePicker = MaskInput.extend("com.bnsf.tne.bnsfContols.TimePicker", /** @lends sap.m.TimePicker.prototype */ {
			metadata : {
				library : "sap.m",
				properties : {
					/**
		...
		TimePicker.prototype._createPicker = function(sFormat) {
			...
			oResourceBundle = sap.ui.getCore().getModel("i18n").getResourceBundle();
