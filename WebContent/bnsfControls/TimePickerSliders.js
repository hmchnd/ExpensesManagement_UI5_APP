sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', './TimePickerSlidersRenderer', './TimePickerSlider', './VisibleItem'],
	function (jQuery, Control, SlidersRenderer, TimePickerSlider, VisibleItem) {
		 ...
		 */
		var TimePickerSliders = Control.extend("com.bnsf.tne.bnsfContols.TimePickerSliders", /** @lends sap.m.TimePicker.prototype */ {
			metadata : {
				library : "sap.m",
				properties : {
				...
				aggregations: {
					 ...
					 */
					_columns: { type: "com.bnsf.tne.bnsfContols.TimePickerSlider", multiple: true, visibility: "hidden" }
				},
				associations: {
					 ...
					 */
					invokedBy: { type: "com.bnsf.tne.bnsfContols.TimePicker", multiple: false }
				}
			},
		...
		TimePickerSliders.prototype._setupLists = function (sFormat) {
			var oRb = sap.ui.getCore().getModel("i18n").getResourceBundle(),
