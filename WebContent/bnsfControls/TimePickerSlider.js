sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', './TimePickerSliderRenderer', 'sap/ui/core/IconPool'],
	function(jQuery, Control, TimePickerSliderRenderer, IconPool) {
		 ...
		 */
		var TimePickerSlider = Control.extend("com.bnsf.tne.bnsfContols.TimePickerSlider", /** @lends sap.m.TimePickerSlider.prototype */ {
			metadata: {
				library: "sap.m",
				properties: {
					/**
				...
				aggregations: {
					 ...
					 */
					items: {type: "com.bnsf.tne.bnsfContols.VisibleItem", multiple: true, singularName: "item"},
