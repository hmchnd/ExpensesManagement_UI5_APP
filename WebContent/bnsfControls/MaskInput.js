...
sap.ui.define(['jquery.sap.global', 'sap/m/InputBase', './MaskInputRule', 'sap/ui/core/Control'], function (jQuery, InputBase, MaskInputRule, Control) {
	"use strict";
	 ...
	 */
	var MaskInput = InputBase.extend("com.bnsf.tne.bnsfContols.MaskInput", /** @lends sap.m.MaskInput.prototype */ {
		metadata: {
			library: "sap.m",
			properties: {
			...
			aggregations: {
				 ...
				 */
				rules: {type: "com.bnsf.tne.bnsfContols.MaskInputRule", multiple: true, singularName: "rule"}
			}
		}
	});
	...
	MaskInput.prototype._setDefaultRules = function () {
		...
		this.addRule(new com.bnsf.tne.bnsfContols.MaskInputRule({
			maskFormatSymbol: "a",
			regex: "[A-Za-z]"
		}), true);
		this.addRule(new com.bnsf.tne.bnsfContols.MaskInputRule({
